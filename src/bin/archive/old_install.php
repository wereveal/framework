...
elseif (!empty($a_install['twig_prefix'])) {
...
elseif (empty($a_constants['twig_prefix']['const_value'])) {
    $a_constants['twig_prefix'] = [
        'const_name'      => 'TWIG_PREFIX',
        'const_value'     => 'site_',
        'const_immutable' => 1
...
if (!empty($a_install['lib_twig_prefix']) && isset($a_constants['lib_twig_prefix']['const_value'])) {
    $a_constants['lib_twig_prefix']['const_value'] = $a_install['lib_twig_prefix'];
}
elseif (!empty($a_install['lib_twig_prefix'])) {
...
elseif (empty($a_constants['lib_twig_prefix']['const_value'])) {
    $a_constants['lib_twig_prefix'] = [
        'const_name'      => 'LIB_TWIG_PREFIX',
        'const_value'     => 'lib_',
        'const_immutable' => 1
...
### Create the main controller for the app ###
    ...
    file_put_contents($app_path . '/Controllers/WebController.php', $controller_text);
